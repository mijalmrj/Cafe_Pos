    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> Northside </h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
        ...
        <ul>
          ...
          <li><a href="../Customer/reservePage.php" data-after="Service"></a></li>
...
$memberships_id = $_SESSION['memberships_id'] ?? null; // Change this to the way you obtain the member ID
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg"> 
        <div class="contact-info">
          ...
          <h1>Email</h1>
          <h2>Northside  cafe@gmail.com</h2> 
        </div>
      </div>
