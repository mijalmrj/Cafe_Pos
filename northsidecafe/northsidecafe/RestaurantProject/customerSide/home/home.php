...
foreach ($categories as $category) {
    ...
    $sqlProducts = "SELECT * FROM products WHERE category_id = $categoryId ORDER BY product_name";
    $resultProducts = mysqli_query($link, $sqlProducts);
    $productsByCategory[$categoryId] = mysqli_fetch_all($resultProducts, MYSQLI_ASSOC);
}
