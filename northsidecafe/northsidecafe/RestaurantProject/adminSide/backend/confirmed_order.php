...
<body class="receipt-body">
    <div class="container">
        ...
        <header class="navbar">
            <div class="navhome">
                <a href="../frontend/index.html"><img src="logos/home.png"></a>
                <a href="../frontend/index.html"><h2>Northside Café</h2></a>
            </div>
            <div class="navlinks">
            ...
            <div class="receipt-box">
                ...
                <div class="receipt-print-option">
                    ...
                    <div>
                        ...
                        <button class="receipt-button" onclick="window.location.href='index.html';">NO</button>
                    </div>
                </div>
            </div>
        </div>
