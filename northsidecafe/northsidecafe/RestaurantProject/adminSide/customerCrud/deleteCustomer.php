...
if (isset($_GET['id'])) {
    // Get the user_id from the URL and sanitize it
    ...
    $deleteSQL = "DELETE FROM membershipships WHERE user_id = ?";
    ...
    if ($stmt->execute()) {
        // membershipship successfully deleted, redirect back to the main page
