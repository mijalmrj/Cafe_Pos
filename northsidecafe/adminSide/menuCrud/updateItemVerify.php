...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // User-provided input
    $provided_memberships_id = $_POST['admin_id']; // Replace with your admin memberships ID
    $provided_password = $_POST['password']; // Replace with your admin memberships password
