...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../panel/pos-panel.php">Northside Staff Panel</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../panel/-panel.php">
                            ...
                            <a class="nav-link" href="../inc/viewmembershipsverify.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-eye"></i></div>
                                View All membershipss
                            </a>
                            ...
                            <a class="nav-link" href="../panel/profiles-panel.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-memberships"></i></div>
                                Member Profiles
                            </a>
                        ...
                        <div class="sb-sidenav-footer">
                            <div class="small">Logged in as:</div>
                                ...
                                if (isset($_SESSION['logged_memberships_id']) && isset($_SESSION['logged_staff_name'])) {
                                    // Display the logged-in staff ID and name
                                    echo "Staff ID: " . $_SESSION['logged_memberships_id'] . "<br>";
