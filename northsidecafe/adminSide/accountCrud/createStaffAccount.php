...
<div class="wrapper">
    ...
    <form method="POST" action="success_create_staff_memberships.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input min=1 type="number" name="memberships_id" placeholder="99" class="form-control <?php echo !$memberships_idErr ?: 'is-invalid'; ?>" id="memberships_id" required value="<?php echo $memberships_id; ?>"><br>
        ...
        <div class="form-group">
            ...
            <input type="text" name="Contact number" placeholder="+60101231234" class="form-control <?php echo !$Contact numberErr ?: 'is-invalid'; ?>" id="Contact number" required value="<?php echo $Contact number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
