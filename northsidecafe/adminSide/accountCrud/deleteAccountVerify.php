    ...
    <div class="login-container">
        <div class="login_wrapper">
            <div class="wrapper">
                ...
                <h5>Admin Credentials needed to Delete memberships</h5>
                <form action="" method="post">
                    ...
                    <button class="btn btn-light" type="submit" name="submit" value="submit">Delete memberships</button>
                    <a class="btn btn-danger" href="../panel/memberships-panel.php" >Cancel</a>
                </form>
            </div>
        </div>
    </div>
