                ...
                <table id="category-table">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<a href='edit_category.php?id=" . $row['category_id'] . "' class='action-button'>Edit</a> | ";
                            echo "<a href='delete_category.php?id=" . $row['category_id'] . "' class='action-button' onclick='return confirm(\"Are you sure?\");'>Delete</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
