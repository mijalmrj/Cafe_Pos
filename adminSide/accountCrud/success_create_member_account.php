...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $membershipship_id = isset($_POST["user_id"]) ? $_POST["user_id"] : null;
    $staff_id = isset($_POST["user_id"]) ? $_POST["user_id"] : null;
    ...
    if ($check_result->num_rows > 0) {
        ...
        $bgColor = "#FFA7A7"; // Custom background color for error
            ...
            // Prepare the SQL query for insertion
                $insert_query = "INSERT INTO membershipss (email, Contact_number, password, user_id) 
                    VALUES (?, ?, ?, ?)";
                $stmt = $link->prepare($insert_query);


                // Bind the parameters
                $stmt->bind_param("ssssii", $email, $register_date, $Contact_number, $password, $user_id);
...
<body>
    ...
    <script>
        ...
        function showPopup() {
            ...
            var countdownInterval = setInterval(function() {
                ...
                if (i <= 0) {
                    ...
                    window.location.href = "createMembermemberships.php";
                }
        ...
        function hidePopup() {
            ...
            setTimeout(function () {
                window.location.href = "createMembermemberships.php"; // Replace with your desired URL
